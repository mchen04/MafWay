...
# convert labels to numerical labels using the dictionary
numerical_labels = [label_dict[label] for label in labels]

# convert labels to one-hot encoded vectors
one_hot_labels = to_categorical(numerical_labels, num_classes=len(categories))

# print shape of images array and one-hot labels array
